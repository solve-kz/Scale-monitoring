...
/// </summary>
public sealed class AppSecurityService : IDisposable
{
    ...
    public AppSecurityService(AuthenticationStateProvider authenticationStateProvider)
    {
    ...
    public async Task InitializeAsync()
    {
        if (_disposed)
        {
            throw new ObjectDisposedException(nameof(AppSecurityService));
        }
